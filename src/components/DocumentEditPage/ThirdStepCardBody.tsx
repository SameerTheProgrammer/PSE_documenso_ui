    ...
    return (
        <Flex w={"100%"} gap={5} direction={"column"}>
            <Menu>
                ...
                <MenuList overflowY={"auto"} maxH={300} w={"max-content"} fontSize={"sm"}>
                    {Object.keys(recipientsList).map((key, index) => (
                        <>
                            <MenuGroup
                                ...
                                fontSize={"sm"}
                            >
                                {recipientsList[key as keyof TRole].map((data, index) => (
                                    <MenuItem key={index} onClick={() => setSelectRecipient(data)}>
            ...
            >
                ...
                <GridItem w={"100%"} h={"100%"}>
                    <Button w={"100%"} h={"100%"} py={6} variant={"outline"} leftIcon={<RxText />}>
                        Text
                    </Button>
                </GridItem>
                <GridItem w={"100%"} h={"100%"}>
...
export default ThirdStepCardBody;
